...
<body>
  ...
  <main class="main" id="top">
    <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3 bg-light opacity-85" data-navbar-on-scroll="data-navbar-on-scroll">
      <div class="container">
        <a class="navbar-brand" href="{{ route('welcome') }}">
          <img class="d-inline-block align-top img-fluid" src="zoufarm/public/assets/img/gallery/logo-icon.png" alt="" width="40" />
          <span class="text-theme font-monospace fs-4 ps-2">Sahabat Tani</span>
        </a>
    ...
    <section class="py-0" id="header">
      <div class="bg-holder d-none d-md-block" style="background-image:url(zoufarm/public/assets/img/illustrations/hero-header.png);background-position:right top;background-size:contain;"></div>
      <div class="bg-holder d-md-none" style="background-image:url(zoufarm/public/assets/img/illustrations/hero-bg.png);background-position:right top;background-size:contain;"></div>
      <div class="container">
        <div class="row align-items-center min-vh-75 min-vh-lg-100">
          <div class="col-md-7 col-lg-6 col-xxl-5 py-6 text-sm-start text-center">
            <h1 class="mt-6 mb-sm-4 fw-semi-bold lh-sm fs-4 fs-lg-5 fs-xl-6 hero-title">Selamat Datang Di<br class="d-block d-lg-block" />Kios Sahabat Tani</h1>
            <p class="mb-4 fs-1 hero-subtitle">"Bersama Sahabat Tani, Tanam Harapan, Panen Sukses"</p>
          </div>
        </div>
      </div>
    </section>
    <section class="py-5" id="Opportunities">
      <div class="bg-holder d-none d-sm-block" style="background-image:url(zoufarm/public/assets/img/illustrations/bg.png);background-position:top left;background-size:225px 755px;margin-top:-17.5rem;"></div>
      <!-- End of Main Content -->
    </section>
    ...
    <script>
      // Animate the hero section when the page is loaded
