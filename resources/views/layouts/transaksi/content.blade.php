                        ...
                        <div class="card-body">
                            <form class="form-right my-2" method="GET" action="{{ route('searchTransaksi') }}">
                                <div class="tombol-cari mb-4">
                                    <input type="text" name="search" class="form-control w-50 d-inline p-2" id="searchTransaksi" placeholder="Masukkan Keterangan / Tanggal Transaksi">
                                ...
                                <tbody>
                                    @foreach ($transaksi as $trx)
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-info" href="{{ route('transaksi.show', $trx->idTransaksi) }}">Show</a>
                                                <a class="btn btn-primary" href="{{ route('transaksi.edit', $trx->idTransaksi) }}">Edit</a>
                                                <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#deleteConfirmation{{ $trx->idTransaksi }}">Delete</button>
                                                <!-- Modal -->
